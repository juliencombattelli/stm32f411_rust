#![doc = "Peripheral access API for STM32F411 microcontrollers (generated using svd2rust v0.31.5 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub enum Interrupt {
    ...
    WWDG = 0,
    #[doc = "1 - EXTI Line 16 interrupt / PVD through EXTI"]
    PVD = 1,
    #[doc = "2 - Tamper and TimeStamp interrupts through"]
    TAMP_STAMP = 2,
...
impl SPI5 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const i2s2ext::RegisterBlock = 0x4001_5000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const i2s2ext::RegisterBlock {
        Self::PTR
