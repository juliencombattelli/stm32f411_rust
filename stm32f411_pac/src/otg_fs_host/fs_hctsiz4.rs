...
pub type R = crate::R<FS_HCTSIZ4_SPEC>;
#[doc = "Register `FS_HCTSIZ4` writer"]
pub type W = crate::W<FS_HCTSIZ4_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XFRSIZ_W<FS_HCTSIZ4_SPEC> {
        XFRSIZ_W::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PKTCNT_W<FS_HCTSIZ4_SPEC> {
        PKTCNT_W::new(self, 19)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DPID_W<FS_HCTSIZ4_SPEC> {
        DPID_W::new(self, 29)
    }
