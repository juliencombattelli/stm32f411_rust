...
pub type R = crate::R<FS_HPRT_SPEC>;
#[doc = "Register `FS_HPRT` writer"]
pub type W = crate::W<FS_HPRT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pcdet(&mut self) -> PCDET_W<FS_HPRT_SPEC> {
        PCDET_W::new(self, 1)
    }
    #[doc = "Bit 2 - Port enable"]
    #[inline(always)]
    #[must_use]
    pub fn pena(&mut self) -> PENA_W<FS_HPRT_SPEC> {
        PENA_W::new(self, 2)
    }
    #[doc = "Bit 3 - Port enable/disable change"]
    #[inline(always)]
    #[must_use]
    pub fn penchng(&mut self) -> PENCHNG_W<FS_HPRT_SPEC> {
        PENCHNG_W::new(self, 3)
    }
    #[doc = "Bit 5 - Port overcurrent change"]
    #[inline(always)]
    #[must_use]
    pub fn pocchng(&mut self) -> POCCHNG_W<FS_HPRT_SPEC> {
        POCCHNG_W::new(self, 5)
    }
    #[doc = "Bit 6 - Port resume"]
    #[inline(always)]
    #[must_use]
    pub fn pres(&mut self) -> PRES_W<FS_HPRT_SPEC> {
        PRES_W::new(self, 6)
    }
    #[doc = "Bit 7 - Port suspend"]
    #[inline(always)]
    #[must_use]
    pub fn psusp(&mut self) -> PSUSP_W<FS_HPRT_SPEC> {
        PSUSP_W::new(self, 7)
    }
    #[doc = "Bit 8 - Port reset"]
    #[inline(always)]
    #[must_use]
    pub fn prst(&mut self) -> PRST_W<FS_HPRT_SPEC> {
        PRST_W::new(self, 8)
    }
    #[doc = "Bit 12 - Port power"]
    #[inline(always)]
    #[must_use]
    pub fn ppwr(&mut self) -> PPWR_W<FS_HPRT_SPEC> {
        PPWR_W::new(self, 12)
    }
    #[doc = "Bits 13:16 - Port test control"]
    #[inline(always)]
    #[must_use]
    pub fn ptctl(&mut self) -> PTCTL_W<FS_HPRT_SPEC> {
        PTCTL_W::new(self, 13)
    }
