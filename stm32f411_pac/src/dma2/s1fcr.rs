...
pub type R = crate::R<S1FCR_SPEC>;
#[doc = "Register `S1FCR` writer"]
pub type W = crate::W<S1FCR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fth(&mut self) -> FTH_W<S1FCR_SPEC> {
        FTH_W::new(self, 0)
    }
    #[doc = "Bit 2 - Direct mode disable"]
    #[inline(always)]
    #[must_use]
    pub fn dmdis(&mut self) -> DMDIS_W<S1FCR_SPEC> {
        DMDIS_W::new(self, 2)
    }
    #[doc = "Bit 7 - FIFO error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn feie(&mut self) -> FEIE_W<S1FCR_SPEC> {
        FEIE_W::new(self, 7)
    }
