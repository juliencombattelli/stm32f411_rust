...
pub type R = crate::R<S4M0AR_SPEC>;
#[doc = "Register `S4M0AR` writer"]
pub type W = crate::W<S4M0AR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn m0a(&mut self) -> M0A_W<S4M0AR_SPEC> {
        M0A_W::new(self, 0)
    }
...
#[doc = "stream x memory 0 address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s4m0ar::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s4m0ar::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
