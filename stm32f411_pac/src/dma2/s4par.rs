...
pub type R = crate::R<S4PAR_SPEC>;
#[doc = "Register `S4PAR` writer"]
pub type W = crate::W<S4PAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa(&mut self) -> PA_W<S4PAR_SPEC> {
        PA_W::new(self, 0)
    }
...
#[doc = "stream x peripheral address register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`s4par::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`s4par::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
