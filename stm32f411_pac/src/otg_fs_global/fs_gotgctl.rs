...
pub type R = crate::R<FS_GOTGCTL_SPEC>;
#[doc = "Register `FS_GOTGCTL` writer"]
pub type W = crate::W<FS_GOTGCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srq(&mut self) -> SRQ_W<FS_GOTGCTL_SPEC> {
        SRQ_W::new(self, 1)
    }
    #[doc = "Bit 9 - HNP request"]
    #[inline(always)]
    #[must_use]
    pub fn hnprq(&mut self) -> HNPRQ_W<FS_GOTGCTL_SPEC> {
        HNPRQ_W::new(self, 9)
    }
    #[doc = "Bit 10 - Host set HNP enable"]
    #[inline(always)]
    #[must_use]
    pub fn hshnpen(&mut self) -> HSHNPEN_W<FS_GOTGCTL_SPEC> {
        HSHNPEN_W::new(self, 10)
    }
    #[doc = "Bit 11 - Device HNP enabled"]
    #[inline(always)]
    #[must_use]
    pub fn dhnpen(&mut self) -> DHNPEN_W<FS_GOTGCTL_SPEC> {
