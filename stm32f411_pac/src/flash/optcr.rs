...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn optlock(&mut self) -> OPTLOCK_W<OPTCR_SPEC> {
        OPTLOCK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Option start"]
    #[inline(always)]
    #[must_use]
    pub fn optstrt(&mut self) -> OPTSTRT_W<OPTCR_SPEC> {
        OPTSTRT_W::new(self, 1)
    }
    #[doc = "Bits 2:3 - BOR reset Level"]
    #[inline(always)]
    #[must_use]
    pub fn bor_lev(&mut self) -> BOR_LEV_W<OPTCR_SPEC> {
        BOR_LEV_W::new(self, 2)
    }
    #[doc = "Bit 5 - WDG_SW User option bytes"]
    #[inline(always)]
    #[must_use]
    pub fn wdg_sw(&mut self) -> WDG_SW_W<OPTCR_SPEC> {
        WDG_SW_W::new(self, 5)
    }
    #[doc = "Bit 6 - nRST_STOP User option bytes"]
    #[inline(always)]
    #[must_use]
    pub fn n_rst_stop(&mut self) -> N_RST_STOP_W<OPTCR_SPEC> {
        N_RST_STOP_W::new(self, 6)
    }
    #[doc = "Bit 7 - nRST_STDBY User option bytes"]
    #[inline(always)]
    #[must_use]
    pub fn n_rst_stdby(&mut self) -> N_RST_STDBY_W<OPTCR_SPEC> {
        N_RST_STDBY_W::new(self, 7)
    }
    #[doc = "Bits 8:15 - Read protect"]
    #[inline(always)]
    #[must_use]
    pub fn rdp(&mut self) -> RDP_W<OPTCR_SPEC> {
        RDP_W::new(self, 8)
    }
    #[doc = "Bits 16:27 - Not write protect"]
    #[inline(always)]
    #[must_use]
    pub fn n_wrp(&mut self) -> N_WRP_W<OPTCR_SPEC> {
        N_WRP_W::new(self, 16)
    }
