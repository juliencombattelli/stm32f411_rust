...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sw0(&mut self) -> SW0_W<CFGR_SPEC> {
        SW0_W::new(self, 0)
    }
    #[doc = "Bit 1 - System clock switch"]
    #[inline(always)]
    #[must_use]
    pub fn sw1(&mut self) -> SW1_W<CFGR_SPEC> {
        SW1_W::new(self, 1)
    }
    #[doc = "Bits 4:7 - AHB prescaler"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtcpre(&mut self) -> RTCPRE_W<CFGR_SPEC> {
        RTCPRE_W::new(self, 16)
    }
    #[doc = "Bits 21:22 - Microcontroller clock output 1"]
    #[inline(always)]
    #[must_use]
    pub fn mco1(&mut self) -> MCO1_W<CFGR_SPEC> {
        MCO1_W::new(self, 21)
    }
    #[doc = "Bit 23 - I2S clock selection"]
    #[inline(always)]
    #[must_use]
    pub fn i2ssrc(&mut self) -> I2SSRC_W<CFGR_SPEC> {
        I2SSRC_W::new(self, 23)
    }
    #[doc = "Bits 24:26 - MCO1 prescaler"]
    #[inline(always)]
    #[must_use]
    pub fn mco1pre(&mut self) -> MCO1PRE_W<CFGR_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mco2(&mut self) -> MCO2_W<CFGR_SPEC> {
        MCO2_W::new(self, 30)
    }
